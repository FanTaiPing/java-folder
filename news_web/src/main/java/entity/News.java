...
public class News {
	...
	public String toString() {
		return "News [id=" + id + ", title=" + title + ", desc=" + desc + ", author=" + author + ", content=" + content
				+ ", createTime=" + createTime + ", updateTime=" + updateTime + ", smImg=" + smImg + ", meImg=" + meImg
				+ ", laImg=" + laImg + ", typeId=" + typeId + "]";
	}
}

...
import com.km.sglototo.build.entity.BuildingCommunity;
import com.km.sglototo.build.entity.UserCommunityRelate;
import com.km.sglototo.build.mapper.BuildingCommunityMapper;
...
//    public Object findAllSysUser(SysUser sysUser,
//                                 @RequestParam(value = "pageNum",defaultValue = "1")Integer pageNum,
...
//            list = sysUserService.findAllSysUser(map);
//            return list;
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
...
//    }
    ...
    public Object findAllSysUser(){
        return new CommonResult().success(sysUserService.findAllSysUser());
    }
//
    @PostMapping("insertUser")
    public Object insertUser(@RequestBody SysUser sysUser){
//        return new CommonResult().success(sysUserService.insertUser(sysUser));
        try {
            if (sysUserService.saves(sysUser)) {
                return new CommonResult().success();
            }
        } catch (Exception e) {
            log.error("保存用户：%s", e.getMessage(), e);
    ...
    public Object deleteUser(int id){
        return new CommonResult().success(sysUserService.deleteUser(id));
    }
}

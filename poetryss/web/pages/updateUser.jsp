...
<div class="container-fluid-m">
    ...
    <form class="row g-3" action="${pageContext.request.contextPath}/UpdateUserServlet?id=${sessionScope.user.id}" enctype="multipart/form-data" method="post">
        <div class="col-sm-10">
            <label for="id" class="col-sm-2 col-form-label">编号</label>
            <input type="text" readonly class="form-control" id="id" name="id" value="${sessionScope.user.id}">
        </div>
        <div class="col-sm-10">
        ...
        <div class="col-sm-10">
            <div class="mb-1">
                ...
                <input type="file" name="userImg" id="userImg" value="${sessionScope.user.userImg}">
            </div>
        </div>
